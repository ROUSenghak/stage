...
largest remaining weakness is buyer identification: only 5.9\% of unique buyer
identities (28 of 475) carry a SIRET code; at the notice level, 2.7\% of all
notices (87 of 3,188) have SIRET-identified buyers. Most grouping therefore
relies on normalised buyer names, which can fragment the same public entity
into several buyer keys and create false negatives.
...
Buyers identified by SIRET (unique buyer keys) & 28 (5.9\%) \\
Buyers identified by normalised name only & 447 (94.1\%) \\
Notices with SIRET-identified buyer & 87 (2.7\%) \\
