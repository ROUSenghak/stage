...
\begin{figure}[H]
\centering
\includegraphics[width=.92\linewidth]{figures/fig_no_ground_truth_validation_framework.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=.9\linewidth]{figures/fig_proxy_event_construction.pdf}
