...
\section*{Mise à jour calibration --- 2026-07-05}

La version recommandée pour l'analyse de survie BOAMP est maintenant le fichier
\texttt{data/processed/boamp\_phase2\_survival\_calibrated\_balanced.csv}. Il
contient 1\,210 appels d'offre éligibles et 269 événements de réapparition
proxy (22,2\%, calibration Sentence-Transformer). La règle équilibrée est :
similarité texte $\geq 0{,}50$, score composite $\geq 0{,}50$, fenêtre
temporelle $W=6$, correction des codes CPV génériques, sans seuil minimum sur
la marge.
