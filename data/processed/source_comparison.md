...
|---|---|---|---|---|---|---|
| Buyer SIRET | Partial | 9.1 | Yes | 100.0 | DECP | Mandatory 14-digit SIRET in DECP; in BOAMP only eForms notices (2024+) carry it. |
...
| CPV code | Yes | 98.1 | Yes | 100.0 | Both | Well filled in both; cross-check to fix generic division-level codes. |
| Amount (EUR) | Partial | 43.0 | Yes | 95.6 | DECP | Mandatory in DECP; in BOAMP mostly on award notices only and format-dependent. |
| Contract duration | Partial | 47.7 | Yes | 99.4 | DECP | dureeMois is a mandatory DECP field; BOAMP declares it on ~3/4 of contract notices only. |
...
| Award date | Partial | 31.8 | No | — | BOAMP | Award notices carry DATE_ATTRIBUTION (95%); absent from DECP. |
| Winner identity | Partial | 27.6 | Yes | 95.5 | Both | BOAMP gives the name, DECP the SIRET; complementary. |
| Procedure type | Yes | 92.9 | Yes | 85.4 | Both | Structured in both sources. |
...
| Linked notices (renewal hints) | Partial | 34.9 | No | — | BOAMP | annonce_lie links award to original notice; key for Week 3. |
